...
export const TRANSFORM_BED_MIDDLE_PORTRAIT: Transform = {p:[3.6349,4.3671,21.1511], r:[0,0.0089,0,-1], s:[0.5579,0.95,0.4883]};
export const TRANSFORM_BED_RIGHT_PORTRAIT: Transform = {p:[5.0884,4.3656,18.7062], r:[0,-0.9978,0,-0.0668], s:[0.5898,1,0.6988]};
export const TRANSFORM_BED_LEFT_PORTRAIT: Transform = {p:[2.0456,4.3677,18.5032], r:[0,0,0,0], s:[0.6988,0.8269,0.8269]};
