...
import Model_ground_glb from "../assets/models/ground.glb";
importedGltf.push({name: "ground", dataUrl: Model_ground_glb});

import Model_ground_01_glb from "../assets/models/ground_01.glb";
importedGltf.push({name: "ground_01", dataUrl: Model_ground_01_glb});
